...
const FEEDS: Record<string, FeedDef> = {
  ...
  'mit-tech-ai': { title: "MIT TR — AI", url: "https://www.technologyreview.com/topic/artificial-intelligence/feed", category: "ai", source: "MIT Tech Review AI", description: "AI coverage from MIT Technology Review." },
};
